...
public:
	...
	/* Set input points */
	void setInput(MatrixDeviceList<float, 3, 1> input, int points_num);
	...
	void radiusSearch(MatrixDeviceList<float, 3, 1> query_points, int points_num, float radius, int max_nn,
	...
	MatrixDeviceList<double, 3, 1> getCentroidList() const;

	/* Get the covariance list. */
	MatrixDeviceList<double, 3, 3> getCovarianceList() const;

	/* Get the pointer to the inverse covariances list. */
	MatrixDeviceList<double, 3, 3> getInverseCovarianceList() const;
	...
	void nearestNeighborSearch(MatrixDeviceList<float, 3, 1> query_points, int point_num, int *valid_distance, double *min_distance, float max_range);
...
private:
	...
	MatrixDeviceList<float, 3, 1> input_cloud_;
	int points_num_;
	MatrixDeviceList<double, 3, 1> centroid_; 				// List of 3x1 double vector
	MatrixDeviceList<double, 3, 3> covariance_;			// List of 3x3 double matrix
	MatrixDeviceList<double, 3, 3> inverse_covariance_;	// List of 3x3 double matrix
	...
	std::vector<MatrixDeviceList<double, 3, 1> > octree_centroids_;
